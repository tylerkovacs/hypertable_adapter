...
module ActiveRecord
  ...
  module ConnectionAdapters
    class HypertableAdapter < AbstractAdapter
      ...
      # Exceptions generated by Thrift IDL has nil values for message.
      # This causes lots of problems for Rails which expects a String
      # value.  Unfortunately, you cannot assign a message to these
      # exception so define a singleton to accomplish same goal.
      ...
      def create_table(table_name, options = {})
        raise "create_table operation not supported by Hypertable."
      end
